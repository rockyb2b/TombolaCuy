...
{
    public static function ReporteApuestaJsonApi(Request $request)
    {
        ...
        $puntoventa = UsuarioPuntoVenta::UsuarioPuntoVentaListarApi();
        $data = [];
       ...
       ,tpago.idTicket,t.idTicket"));
        ...
        foreach ($listar as $l) {
            ...
            $data [] = [
                ...
                'Turno' => ucwords($turno),
                'Evento' => $l->Evento,
                'Fecha' => $l->fechaoperacion,
                'TotalJugadores' => $l->Jugadores,
                'TotalGanadores' => $l->totalganadores,
                'MontoTotalApostado' => $l->apuestas,
                'MontoTotalPagado' => $l->Pagos,
                'Pleno' => $l->ganador,
...
//                    'rgb_letra' => $l->rgbLetra,
    ...
    public static function ReporteCierreCaja()
    {
     ...
     public static function CargarDatosCierre()
    {
        $IdUsuario = Auth::user()->idUsuario;
        $resultado = DB::select(DB::raw("select ac.idAperturaCaja,ac.idTurno,c.nombre caja,p.nombre puntoventa,ac.fechaRegistro fechaOperacion,ac.fechaCierre,
        IFNULL(( select sum(t.montototal) from ticket t
