...
Route::post('RevisarSesionFk', 'AutenticacionController@RevisarSesion')->name('RevisarSesionFk');
#endregion
...
Route::post('ClienteVistaCajaTablaFk', 'ClienteVistaController@ClienteVistaCajaTablaFk');
Route::post('HistorialDatosJsonFk', 'ClienteVistaController@HistorialDatosJson');
Route::post('ClienteVistaGuardarTicketFk', 'ClienteVistaController@GuardarTicket');
Route::post('ClienteVistaHistorialJackpotDatosJsonFk', 'ClienteVistaController@HistorialJackpotDatosJsonFk');
Route::post('EventoActual', 'ClienteVistaController@EventoActual');
...
Route::post('BuscarTicket_paraCancelarFk', 'VentaController@BuscarTicket_paraCancelar');
Route::post('Cancelar_TicketFk', 'VentaController@Cancelar_Ticket');
Route::post('BuscarTicketPagadoFk', 'VentaController@BuscarTicketPagado');
...
Route::post('CargarDatosCierreFk', 'ReporteController@CargarDatosCierre');
