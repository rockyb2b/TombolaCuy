	...
	<div id="DIV_ESTADISTICA"  class="nuevo_lados borde-lateral">
		<div class="imagen_div">
			<div class="image_apuesta_div">
				<img src="images/logocorp2b.png" alt="Torito">		
			</div>
		</div>
...
<!-- 	<script src="{{asset('../assets/js/FBXloader.js')}}"></script>
<script src="{{asset('../assets/js/Inflate.min.js')}}"></script> -->
...
<!-- <script src="{{asset('../assets/js/animacion_cuy/animacion_ganador.js')}}"></script> -->
...
<script src="{{asset('../assets/js/animacion_cuy/jquery.fireworks.js')}}"></script>
<script src="{{asset('../assets/js/animacion_cuy/jquery.fuegos_artificiales.js')}}"></script>
<script src="{{asset('../assets/js/animacion_cuy/jquery.confeti.js')}}"></script>
<script src="{{asset('../assets/js/animacion_cuy/jquery.burn.min.js')}}"></script>
<script src="{{asset('../assets/js/animacion_cuy/jquery.shiningImage.min.js')}}"></script>
