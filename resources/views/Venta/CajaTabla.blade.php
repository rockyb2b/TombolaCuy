                        ...
                        <div class="TOMBOLACUY" style="display:none;/*height:89vh;/">
                            <div class=" rowcabecera">
                                ...
                                <div class=" rowcabecera_datos" id="row_datosevento">
                                    ...
                                    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.1), inset 0 -3px 2px rgba(0, 0, 0, 0.12), 0 5px 5px rgba(0, 0, 0, 0.4), 0 0 5px rgba(0, 0, 0, 0.4), inset 0 -15px 10px rgba(0, 0, 0, 0.25);padding-right: 1.6%; display:flex;align-item:center;
            justify-content:end" id="jackpotsuma">0.00
                                    </div>
