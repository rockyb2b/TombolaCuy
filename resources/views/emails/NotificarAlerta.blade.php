                                        ...
                                        <tr style="margin: 0; padding: 0;">
                                            <td align="center"
                                                ...
                                                <div style="margin-bottom: 30px; text-align: left;" align="left">
                                                    <a href="#" utm_content="igg-header-logo" utm_medium="email"
                                                       style="color: #eb1478; text-decoration: none;">
                                                        <img alt="" class="logo"
                                                             src="https://apuestatotal.com/img/logo.png?201901291231"
                                                             style="display: block; border: none;" width="125">
                                                    </a>
                                                </div>

                                                {{--<p style="font-size: 22px; line-height: 22px; margin: 0; padding: 0;">{{$PuntoVenta}},</p>--}}

                                                <div style="text-align: left;" align="left">
                                                    <p style="font-size: 20px; line-height: 28px; margin: 20px 0 0; padding: 0;">
                                                        {{--El punto de venta <b>{{strtoupper($PuntoVenta)}}</b> ha excedido el monto configurado por local--}}
                                                        {{$body}}
                                                        <br>
                                                        <br>
                                                        Monto Local : <b>{{$MontoPuntoVenta}}</b>
                                                        <br>
                                                        Monto Configurado : <b>{{$MontoConfiguracionAlerta}}</b>
                                                    </p>
                                                </div>

                                                {{--<p style="font-size: 20px; line-height: 22px; margin: 0; padding: 0; text-align: center">--}}
                                                {{--<a href="#" style="margin-top: 40px; color: #ffffff; text-decoration: none; display: inline-block; font-family: sans-serif; font-size: 20px; line-height: 46px; text-align: center; -webkit-text-size-adjust: none; font-weight: bold; white-space: nowrap; text-transform: uppercase; background-color: #00000F; padding: 5px 50px;">Confirmar y Registrar</a>--}}
                                                {{--</p>--}}

                                                <div style="width: 100%; margin: 35px 0px; border: 1px solid #e9e9e9;"></div>
