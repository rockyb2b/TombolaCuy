...
<head>
	...
	<link rel="shortcut icon" href="{{asset('images/logotorito.png')}}">
...
<body>
    <div id="VISTA_VENTA" class="content container-fluid" style="display:none">            
        @include('ClienteVista.ClienteVistaCajaTabla')
    </div>

	<div  id="DIV_CARGANDO" class="cuy_cargando"></div>
    <div id="VISTA_CUY" style = "display:none">
